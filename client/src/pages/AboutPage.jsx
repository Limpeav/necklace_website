  ...
  <section className="container-shell py-14">
    <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
      ...
      <div className="surface-card p-8 md:p-10">
        <p className="eyebrow">About Lunelle</p>
        ...
        <div className="mt-6 space-y-5 text-sm leading-8 text-stone-300">
          <p>Lunelle is built around necklaces that feel elevated but wearable, with collections spanning pearl, statement, minimal, and layered categories.</p>
